...
public class ElementarySchoolGui extends JPanel{
	WindowFrame frame;
   JPanel p1= new JPanel();
   JPanel p2= new JPanel();
   JPanel p3= new JPanel();
      public ElementarySchoolGui(WindowFrame frame) {
    	  this.frame = frame;
         ...
         p1.add(new JTextArea("            "));
         p1.add(new JButton("do you have a parent's email? (y/n)"));
         p1.add(new JTextArea("            "));
         p1.add(new JButton("your name: "));
         p1.add(new JTextArea("            "));
         p1.add(new JButton("your parent's phonenumber:  "));
         p1.add(new JTextArea("            "));
